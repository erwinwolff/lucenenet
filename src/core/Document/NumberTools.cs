...
namespace Lucene.Net.Documents
{
    ...
    public class NumberTools
    {
...
#else
        public static readonly string MIN_STRING_VALUE = NEGATIVE_PREFIX + "0000000000000000";
#endif
...
#else
        public static readonly string MAX_STRING_VALUE = POSITIVE_PREFIX + "7fffffffffffffff";
#endif
...
#else
            string num = System.Convert.ToString(l, RADIX);
#endif
        ...
        private static long[] powersOf36 =
            {
                1L,
                36L,
                36L*36L,
