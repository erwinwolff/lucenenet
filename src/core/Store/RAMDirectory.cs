...
namespace Lucene.Net.Store
{
    ...
    public class RAMDirectory : Directory
    {
        ...
        protected internal HashMap<string, RAMFile> fileMap = new HashMap<string, RAMFile>();
        protected internal long internalSizeInBytes = 0;
        ...
        public override string[] ListAll()
        {
            lock (this)
            {
                ...
                ISet<string> fileNames = Support.Compatibility.SetFactory.CreateHashSet(fileMap.Keys);
